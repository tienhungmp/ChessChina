...
namespace Xiangqi.Pawns
{
    class Soldier : IPawn
    {
        ...
        public void Paint(Graphics g, int x, int y, int imageType)
        {
            ...
            {
                case 0:
                    g.DrawImage(playerSide == PlayerSide.BLACK ? PawnBitmapCollection.soldierChineseBlack : PawnBitmapCollection.soldierChineseRed, pawnLocation);
                    break;
                case 1:
                    g.DrawImage(playerSide == PlayerSide.BLACK ? PawnBitmapCollection.soldierWesternBlack : PawnBitmapCollection.soldierWesternRed, pawnLocation);
                    break;
            }
        }
        ...
        {
            return playerSide == side ? 100 : -100;
        }
    }
}
